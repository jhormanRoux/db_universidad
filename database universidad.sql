...
insert into alumno(id_alumno,nif,nombre,apellido1,apellido2,ciudad,direccion,telefono,fecha_nacimiento,sexo)values(1,119281441,'andres','facundo','sanchez','armenia','cra20#17N20','157632157','2000-09-09','H'),
(2,119281442,'paola','facundo','sanchez','pereira','cra20#17N21','157632156','2000-09-10','M'),(3,119281443,'ximena','facundo','sanchez','filandia','cra20#17N22','257632157','2000-10-09','M'),
(4,119281441,'jorge','facundo','sanchez','armenia','cra20#17N20','157632157','1995-09-09','H'),(5,119281441,'juan','facundo','sanchez','chile','cra20#17N20','157632157','1990-09-09','H');
...
insert into profesor(id_profesor,nif,nombre,apellido1,apellido2,ciudad,direccion,telefono,fecha_nacimiento,sexo,id_departamento)values(1,152369587,'andres','facundo','sanchez','armenia','cra20#17N20','152456398','2000-09-09','H',01),
(2,152369587,'andres','facundo','sanchez','armenia','cra20#17N20','152456398','2000-09-09','H',01),(3,152369587,'andres','facundo','sanchez','armenia','cra20#17N20','152456398','2000-09-09','H',01),
(4,152369587,'andres','facundo','sanchez','armenia','cra20#17N20','152456398','2000-09-09','H',01),(5,152369587,'andres','facundo','sanchez','armenia','cra20#17N20','152456398','2000-09-09','H',01);
